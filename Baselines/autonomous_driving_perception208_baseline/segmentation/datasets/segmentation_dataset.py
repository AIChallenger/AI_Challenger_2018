...
_BDD100K_INFORMATION =  DatasetDescriptor(
    splits_to_sizes={
        'train': 70000,  # num of samples in images/training
        'val': 10000,  # num of samples in images/validation
    },
    num_classes=4,
    ignore_label=255,
)
